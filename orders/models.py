...
class OrderManagerQueryset(models.query.QuerySet):
    ...
    def by_weeks_range(self, weeks_ago=7, number_of_weeks=2):
        ...
        days_age_start = weeks_ago * 7
        days_ago_end = days_age_start - (number_of_weeks * 7)
        start_date = timezone.now() - datetime.timedelta(days=days_age_start)
...
def pre_save_create_order_id(sender, instance, *args, **kwarts):
...
class ProductPurchase(models.Model):
    ...
    billing_profile = models.ForeignKey(BillingProfile, on_delete=models.CASCADE, related_name='product_purchase')
